        ...
        <div className="flex flex-col gap-4">
          ...
          >
            <motion.a
              ...
              onClick={addRipple}
              className="group relative inline-flex items-center gap-2 px-4 py-2 overflow-hidden rounded-lg bg-neutral-900/80 dark:bg-neutral-800/80 backdrop-blur-md border border-neutral-700/40 text-white font-medium transition-all duration-300 hover:bg-neutral-800/80 hover:border-neutral-600/60"
